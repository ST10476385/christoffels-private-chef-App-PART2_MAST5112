 ...
 * It either deletes or moves the /app, /components, /hooks, /scripts, and /constants directories
 * to /app-example based on user input, then creates a new /app directory with index.tsx and _layout.tsx.
 */
